<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
  <b-modal hide-footer v-bind:id="modalId">
    ...
    <b-button @click="() => register(username, password, getAttributeList())" block class="mt-3" variant="primary">Create</b-button>
  </b-modal>
</template>
...
<script>
  export default {
    ...
    methods: {
      getAttributeList() {
        return Object.entries(this.attributes).map(([Name, Value]) => ({ Name, Value }));
      }
    },
  }
</script>
